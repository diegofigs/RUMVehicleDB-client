(function() {
  ...
  VehicleInformationService.$inject = ['$http', '$q',
    '$stateParams', '$filter'];
  ...
  VehicleInformationService.prototype
    .getVehicleInformationByVin = function(vin) {
    var _this = this;
    var df = _this.$q.defer();
    _this.vehicle = {};
  ...
  VehicleInformationService.prototype
    .getVehiclePhotoURL = function(make, model, year) {
    var _this = this;
    var df = _this.$q.defer();
    _this.vehicle = {};
    ...
    '?api_key=' + _this.APIKey)
		.success(function(data) {
  console.log(data);
  var frontDriverVehicleURLs = _this.$filter('filter')(data.photos,
    {shotTypeAbbreviation: 'FQ'})[0].sources;
