(function() {
  ...
  var VehiclesService = function($http, $q, $stateParams, $filter) {
    var _this = this;
    _this.$http = $http;
    _this.$q = $q;
  ...
  VehiclesService.$inject = ['$http', '$q', '$stateParams', '$filter'];
  app.service('VehiclesService', VehiclesService);

  VehiclesService.prototype.getVehicles = function(licensePlateID,
                                                   owner,
                                                   make,
                                                   model) {
    var _this = this;
    ...
    df.resolve(_this.vehicles, _this.total);
    // })
    // .error(function(err) {
  ...
  VehiclesService.prototype.getVehicle = function() {
    var _this = this;
    var df = _this.$q.defer();
    ...
    _this.vehicle = data.data;
    df.resolve(_this.vehicle);
    // }).error(function(err) {
    // 	df.reject(err.message);
    // });
  ...
  VehiclesService.prototype.addVehicle = function(json) {
    var _this = this;
    // console.log(json);
    var df = _this.$q.defer();
  ...
  VehiclesService.prototype.editVehicle = function(vehicleID, json) {
    var _this = this;
