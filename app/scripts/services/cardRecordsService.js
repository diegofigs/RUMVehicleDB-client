(function(){
	...
	var CardRecordsService = function($http, $q, $stateParams, $filter){
		var _this = this;
		_this.$http = $http;
		_this.$q = $q;
	...
	CardRecordsService.$inject = ['$http', '$q', '$stateParams', '$filter'];
	app.service('CardRecordsService', CardRecordsService);

	CardRecordsService.prototype.getRecords = function (cardID) {
		var _this = this;
	...
	CardRecordsService.prototype.getRecord = function (cardID) {
		var _this = this;
		var df = _this.$q.defer();
	...
	CardRecordsService.prototype.addRecord = function (json) {
		var _this = this;
		// console.log(json);
		var df = _this.$q.defer();
	...
	CardRecordsService.prototype.editRecord = function (cardID, json) {
		var _this = this;
