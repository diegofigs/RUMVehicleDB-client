...
var VehiclesCtrl = function($stateParams, $state, $filter, $log, $mdDialog, VehiclesService, VehicleInformationService){
	var vm = this;
...
VehiclesCtrl.$inject = ['$stateParams', '$state', '$filter', '$log', '$mdDialog', 'VehiclesService', 'VehicleInformationService'];
...
app.config(function($stateProvider) {
    ...
    .state('vehicles', {
        url: '/vehicles',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/vehicles/vehicles.html?v='+window.appVersion,
    ...
    .state('vehicles.view', {
        ...
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/vehicles/view-vehicle.html?v='+window.appVersion,
        controller: 'VehiclesCtrl',
        controllerAs: 'vm'
    })
    .state('vehicles.add', {
        url: '/vehicle/add',
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/vehicles/add-vehicle.html?v='+window.appVersion,
        controller: 'VehiclesCtrl',
        controllerAs: 'vm'
    })
    .state('vehicles.edit', {
        ...
        parent: 'dashboard',
        templateUrl: 'views/pages/dashboard/vehicles/edit-vehicle.html?v='+window.appVersion,
        controller: 'VehiclesCtrl',
        controllerAs: 'vm'
    });
});
...
VehiclesCtrl.prototype.getVehicles = function(){
	...
	vm.VehiclesService.getVehicles(vm.licensePlateSearch, vm.makeSearch, vm.modelSearch)
	.then(function() {
...
VehiclesCtrl.prototype.initEditVehicle = function(){
	...
	.then(function() {
		...
		if(vm.vehicle.vin) {
			...
			vm.models = vm.$filter('filter')(vm.makes, {name: vm.vehicle.make}, true)[0].models;
			vm.model = vm.$filter('filter')(vm.models, {name: vm.vehicle.model}, true)[0];
			if (!vm.model) {
