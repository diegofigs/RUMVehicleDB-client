...
var VehicleRecordsCtrl = function($stateParams,
                                  $state,
                                  $filter,
                                  $log,
                                  VehicleRecordsService,
                                  VehiclesService) {
  var vm = this;
...
VehicleRecordsCtrl.$inject = ['$stateParams',
  '$state', '$filter', '$log',
  'VehicleRecordsService', 'VehiclesService'];
...
app.config(function($stateProvider) {
  $stateProvider
    .state('vehicleRecords', {
      ...
      '/vehicle-records/vehicle-records.html?v=' + window.appVersion,
    ...
    .state('vehicleRecords.view', {
      ...
      parent: 'dashboard',
      templateUrl: 'views/pages/dashboard' +
      '/vehicle-records/view-vehicle-record.html?v=' + window.appVersion,
      controller: 'VehicleRecordsCtrl',
      controllerAs: 'vm'
    })
    .state('vehicleRecords.add', {
      ...
      parent: 'dashboard',
      templateUrl: 'views/pages/dashboard' +
      '/vehicle-records/add-vehicle-record.html?v=' + window.appVersion,
      controller: 'VehicleRecordsCtrl',
      controllerAs: 'vm'
    })
    .state('vehicleRecords.edit', {
      ...
      parent: 'dashboard',
      templateUrl: 'views/pages/dashboard' +
      '/vehicle-records/edit-vehicle-record.html?v=' + window.appVersion,
      controller: 'VehicleRecordsCtrl',
      controllerAs: 'vm'
    });
});
