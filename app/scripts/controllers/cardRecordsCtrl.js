(function(){
	...
	var CardRecordsCtrl = function($stateParams, $state, $filter, $log, CardRecordsService, CardsService){
		var vm = this;
	...
	CardRecordsCtrl.$inject = ['$stateParams', '$state', '$filter', '$log', 'CardRecordsService', 'CardsService'];
	...
	app.config(function($stateProvider) {
        ...
        .state('cardRecords', {
            ...
            parent: 'dashboard',
            templateUrl: 'views/pages/dashboard/card-records/card-records.html?v='+window.appVersion,
        ...
        .state('cardRecords.view', {
            ...
            parent: 'dashboard',
            templateUrl: 'views/pages/dashboard/card-records/view-card-record.html?v='+window.appVersion,
            controller: 'CardRecordsCtrl',
            controllerAs: 'vm'
        })
        .state('cardRecords.add', {
            ...
            parent: 'dashboard',
            templateUrl: 'views/pages/dashboard/card-records/add-card-record.html?v='+window.appVersion,
            controller: 'CardRecordsCtrl',
            controllerAs: 'vm'
        })
        .state('cardRecords.edit', {
            ...
            parent: 'dashboard',
            templateUrl: 'views/pages/dashboard/card-records/edit-card-record.html?v='+window.appVersion,
            controller: 'CardRecordsCtrl',
            controllerAs: 'vm'
        });
	});
